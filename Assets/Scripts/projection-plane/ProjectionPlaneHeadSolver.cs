...
public class ProjectionPlaneHeadSolver : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.LookAt(transform.position + Camera.main.transform.rotation * new Vector3(0,1,0),Camera.main.transform.rotation * new Vector3(0,0,-1));
